...
public class GateioAccountServiceTest extends GateioExchangeWiremock {
  ...
  GateioAccountServiceRaw rawAccountService =
  ...
  public void withdrawFundsTest() throws IOException, InterruptedException {
    AccountInfo accountInfo = accountService.getAccountInfo();
    GateioCurrencyMetaData currencyMetaData = (GateioCurrencyMetaData) exchange.getExchangeMetaData().getCurrencies().get("USDT");
